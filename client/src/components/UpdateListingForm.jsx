...
export default function UpdateListingForm({ listing, currentUser, onSuccess, onCancel }) {
      ...
      <div className='flex flex-col flex-1 gap-4'>
        ...
        <div className="flex justify-between mt-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-80"
            type="submit"
          >
